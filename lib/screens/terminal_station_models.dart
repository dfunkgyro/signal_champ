...
enum BlockState { clear, occupied }
...
class BlockSection {
  ...
  set x(double value) {
    final currentLength = endX - startX;
    startX = value;
...
class Point {
  ...
  String? normalConnection;
  String? reverseConnection;
  ...
  PointPosition get currentPosition => position;
  PointPosition get normalPosition => PointPosition.normal;
...
class SignalRoute {
  ...
  List<String> get requiredBlocks => requiredBlocksClear;
  Map<String, PointPosition> get pointPositions => requiredPointPositions;
}
...
class Carriage {
  ...
  set offsetFromLead(double offsetFromLead) {}
